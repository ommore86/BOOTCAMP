...
# Formatting-
str1 = "My name is {}. I am studing in {}. I live in {}".format("Om","VESIT","Kalyan")
str1 = "My name is {2}. I am studing in {0}. I live in {1}".format("VESIT","Kalyan","Om")
str1 = "My name is {n}. I am studing in {c}. I live in {p}".format(n="Om",c="VESIT",p="Kalyan")
print(str1)
